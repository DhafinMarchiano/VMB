      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <p class="breadcrumb-custom"><a href="{{ router('landing') }}">Home</a> <span class="mx-2">&gt;</span> <span>About Us</span></p>
          </div>
        </div>
      </div>
    </div>  
      ...
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-primary">
            <h2 class="font-weight-light text-primary" data-aos="fade">Vision and Mission</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-6 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
            <div class="how-it-work-item">
              ...
              <div class="how-it-work-body">
                <h2>Mission</h2>
                <p class="mb-5">
                  To become the best logistics partner which prioritize safety, accuracy, security and service to our customers</p>
              </div>
            </div>
          </div>
            ...
            <div class="how-it-work-item">
              ...
              <div class="how-it-work-body">
                ...
                <ul class="ul-check list-unstyled white">
                  <li class="text-white">Provide the best quality in logistical services</li>
                  <li class="text-white">Continuous development of professional management system</li>
                  <li class="text-white">To develop relations with support from professional human resources</li>
                  <li class="text-white">Promote company growth in order to achieve employee welfare</li>
                </ul>
              </div>
            </div>
          </div>
