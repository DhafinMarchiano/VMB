...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <a href="{{route('customer.logout')}}" class="dropdown-item dropdown-footer">Logout</a>
          </div>
        </li>
        <li class="nav-item">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="{{ route('customer.orders') }}" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ route('customer.orders') }}" class="nav-link {{ (request()->is('customer/pesanan*')) ? 'active' : ''  }}">
            ...
            <li class="nav-item">
              <a href="{{ route('customer.profile') }}" class="nav-link {{ (request()->is('customer/profil*')) ? 'active' : ''  }}">
